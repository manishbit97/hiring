...
if (!isset($_SESSION['loggedin'])  && ($_SESSION['team']['status'] != 'Admin')) {
    echo "<br/><br/><br/><div style='padding: 10px;'><h1>You are not Allowed to do this :(</h1>Your actions are being monitored.</div><br/><br/><br/>";
}
else {
        ...
        if (isset($_GET['code'])) {
            ...
            if ($res) {
                ...
                <script type="text/javascript"
                        src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushCSharp.js"></script>
                <script type="text/javascript" src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushJava.js"></script>
                <script type="text/javascript"
                        src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushJScript.js"></script>
                <script type="text/javascript"
                        src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushPascal.js"></script>
                ...
                <script type="text/javascript"
                        src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushPlain.js"></script>
                <script type="text/javascript"
                        src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushPython.js"></script>
                <script type="text/javascript" src="<?php echo SITE_URL; ?>/syntax-highlighter/shBrushRuby.js"></script>
                <link type="text/css" rel="stylesheet"
                      href="<?php echo SITE_URL; ?>/syntax-highlighter/shCoreDefault.css"/>
                <script type="text/javascript">
                                ...
                                <form class="form-inline" method="post" action="<?php echo SITE_URL; ?>/process.php">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="access">
                                            <option value="public" <?php if ($res['access'] == "public") echo "selected='selected' "; ?>>
                                                Public
                                            </option>
                                            <option value="private" <?php if ($res['access'] == "private") echo "selected='selected' "; ?>>
                                                Private
                                            </option>
                                            <option value="deleted" <?php if ($res['access'] == "deleted") echo "selected='selected' "; ?>>
                                                Deleted
                                            </option>
                                        </select>
                                    </div>
                ...
                if (($prob['displayio'] == 1 && ($res['result'] == 'AC' || $res['result'] == 'WA' || $res['result'] == 'PE')) || (isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin')) {
                    ...
                    if (strlen($prob['input']) <= 102400) {
                        ?>
                        <div class='col-md-4' style='overflow-x: auto;'><h4>Input</h4>
                            <div class='limit'>
                    ...
                    if (strlen($prob['output']) <= 102400 && strlen($res['output']) <= 102400) {
                        ...
                        $lines = "[" . implode(',', $lines) . "]";
                        ?>
                        <div class='col-md-4' style='overflow-x: auto;'><h4>Correct Output</h4>
                            <div class='limit'>
                                <pre class='brush: text'><?php echo $prob['output']; ?></pre>
                            </div>
                        </div>
                        <div class='col-md-4' style='overflow-x: auto;'><h4>Actual Output</h4>
                            <div class='limit'>
                                <pre class='brush: text;<?php if ($res['result'] != 'AC') echo " highlight: " . $lines; ?>;'
                                     id="output"><?php echo ($res['result'] != 'AC') ? (stripslashes($res['output'])) : ($prob['output']); ?></pre>
                            </div>
                        </div>
                        <?php
                    } else {
