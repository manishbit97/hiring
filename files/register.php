<?php
    ...
    if ($judge['value'] != "Lockdown" || (isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin')) {
        if ($_SESSION['team']['status'] == 'Normal' || (!isset($_SESSION['loggedin']))) {
            redirectTo(SITE_URL);
        }
        ?>
        ...
        <form method='post' class='form-horizontal' role="form"
              action='<?php echo SITE_URL; ?>/process.php'>
            <div class='col-lg-12'>
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                        <input class='form-control' type='text' name='teamname' id='teamname' required
                               data-placement='right' title='Only alphabets numbers _ and @ are allowed' <?php
                ...
                <div class='form-group'>
                    ...
                    <div class='col-lg-4'><input class='form-control' type='password' name='repassword' id='pass2'
                                                 required/></div>
                </div>
                <div class='form-group'>
...
<!--                    <label class='col-lg-2 control-label' for='roll1'>Roll No</label>-->
                    <div class='col-lg-4'><input class='form-control' type='hidden' name='roll1' id='roll1'
                                                 data-placement='right' title='Ex : BE/10206/2013'<?php
...
<!--                    <label class='col-lg-2 control-label' for='branch1'>Branch</label>-->
                    <div class='col-lg-4'><input class='form-control' type='hidden' name='branch1' id='branch1'
                                                  <?php
                ...
                <div class='form-group'>
                    ...
                    <div class='col-lg-4'><input class='form-control' type='email' name='email1' id='email1'
                                                 required <?php
                ...
                <div class='form-group'>
                    ...
                    <div class='col-lg-4'><input class='form-control' type='number' name='phno1' id='phno1'
                                                 required <?php
...
<!--                    <div class='col-lg-8'><input class='form-control' type='text' name='roll2' id='roll2'-->
<!--                                                 data-placement='right' title='Ex : BE/10206/2013'--><?php
...
<!--                    <div class='col-lg-8'><input class='form-control' type='text' name='roll3' id='roll3'-->
<!--                                                 data-placement='left' title='Ex : BE/10206/2013'--><?php
...
<!--            </div>-->
            <div class='col-lg-12'>
                <div class='form-group'>
                    ...
                    <div class='col-lg-4'><input type='submit' name='register' value='Submit'
