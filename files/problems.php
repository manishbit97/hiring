        ...
        if (isset($_GET['code'])) {
            ...
            if ($result == NULL) {
                ...
                if ($flag == 0) {
                    ...
                    echo "<span class='btn-group' style='float:right;'>" . ((isset($_SESSION['loggedin'])) ? ("<a class='btn btn-default' href='" . SITE_URL . "/status/$_GET[code]," . $_SESSION['team']['name'] . "'>My Submissions</a></span>") : ("")) . "<a class='' href='#'></a></div>
                ...
                <div class='col-md-8'>
                    ...
                    if (isset($_SESSION['loggedin'])) {
                        ...
                        <form action="<?php echo SITE_URL; ?>/process.php" role='form' method="post">
                            ...
                            <textarea class='form-control' style="" name="query"
                                      placeholder="Post clarification..."></textarea><br/>
